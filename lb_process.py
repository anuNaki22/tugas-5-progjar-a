...
class BackendList:
	def __init__(self):
		...
		self.servers.append(('127.0.0.1',8006))
		self.servers.append(('127.0.0.1',8007))
		self.servers.append(('127.0.0.1',8008))
		self.current=0
	def getserver(self):
...
def Server():
	...
	my_socket.listen(1)
	logging.warning("load balancer running on port {}".format(44444))
	...
	with ProcessPoolExecutor(20) as executor:
		while True:
				...
				try:
					...
					print(f"Jumlah proses yang sedang aktif: {len(jumlah)}")
					#print(jumlah)
